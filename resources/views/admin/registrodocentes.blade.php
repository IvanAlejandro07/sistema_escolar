          ...
          <div class="row">
            <div class="col-md-7 col-xs-12">
              <div class="continer centerIt">
                <div>
                  <h4>¡Bienvenid@ al <em>apartado de registro de docentes</em>!</h4>
                </div>
              </div>
            </div>
            <div class="col-md-5">
              <div class="right-content">
                <div class="top-content">
                  <h6>Complete el <em>siguiente formulario</em> para registrar al docente:</h6>
                </div>
                <form id="contact" action="" method="post">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                        <fieldset>
                          <input name="identificationnumber" type="text" class="form-control" id="identificationnumber" placeholder="No. Identificación" required="">
                        </fieldset>
                      </div>
                    <div class="col-md-12">
                      <fieldset>
